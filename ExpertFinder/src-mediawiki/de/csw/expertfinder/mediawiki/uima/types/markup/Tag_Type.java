...
public class Tag_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.csw.expertfinder.mediawiki.uima.types.markup.Tag");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "de.csw.expertfinder.mediawiki.uima.types.markup.Tag");
